...
public class BookingScheduleRuleVo {
	...
	@ApiModelProperty(value = "可预约日期",example = "1")
	...
	@ApiModelProperty(value = "周几",example = "1")
	private String dayOfWeek;

	@ApiModelProperty(value = "就诊医生人数",example = "1")
	private Integer docCount;

	@ApiModelProperty(value = "科室可预约数",example = "1")
	private Integer reservedNumber;

	@ApiModelProperty(value = "科室剩余预约数",example = "1")
