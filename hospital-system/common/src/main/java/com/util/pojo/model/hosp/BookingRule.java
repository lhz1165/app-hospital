...
public class BookingRule {
	...
	@ApiModelProperty(value = "预约周期",example = "1")
	private Integer cycle;

	@ApiModelProperty(value = "放号时间",example = "1")
	private String releaseTime;

	@ApiModelProperty(value = "停挂时间",example = "1")
	private String stopTime;

	@ApiModelProperty(value = "退号截止天数（如：就诊前一天为-1，当天为0）",example = "1")
